...
In my SalesForce case, my SIEM drops this data into the description field. You'll see that in this particular alert, the user 'jlazerus' is adding the user 'jsmith' to the Domain Admins group. From it, we'll need to parse the Source User.
